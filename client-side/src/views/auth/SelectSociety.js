                ...
                <div className="rounded-t mb-0 px-6 py-6">
                    <div className="btn-wrapper text-center text-black">
                        ...
                        <select>
                            ...
                            (
                                <option value={soc.name}>{soc.name} , {soc.address}</option>
                            )
                            )} 
                        </select>
                            ...
                            <div className="text-center mt-6">
                                <button
                                className="bg-blueGray-800 text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full lg:w-4/12 ease-linear transition-all duration-150"
                                onClick={dashboard}
                                >
                                    Submit
                                </button>
